...
def train():
    parser = argparse.ArgumentParser(
        description='Parameters for training MyModel')
    ...
    # build model
    logger.info("Building the model of MyModel")
    MyModel = denoise_pytorch_trainer.MyModel()
    # build optimizer
    logger.info("Building the optimizer of MyModel")
    optimizer = make_optimizer(MyModel.parameters(), opt)
    # build dataloader
    logger.info('Building the dataloader of MyModel')
    ...
    # build trainer
    logger.info('Building the Trainer of MyModel')
    trainer = denoise_pytorch_trainer.Trainer(MyModel, optimizer, scheduler, opt)
    trainer.run()
